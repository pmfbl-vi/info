...
/**
 * Applies AND-OR-GRAPH-SEARCH to a non-deterministic version of the Vacuum
 * World.
 * 
 * 
 * @author Andrew Brown
...
public class NondeterministicVacuumEnvironmentDemo
{
  ...
  private static void startAndOrSearch()
  {
    ...
    // create problem
    NondeterministicProblem problem = new NondeterministicProblem( state,
        new VacuumWorldActions(), new VacuumWorldResults( agent ),
        new VacuumWorldGoalTest( agent ), new DefaultStepCostFunction() );
