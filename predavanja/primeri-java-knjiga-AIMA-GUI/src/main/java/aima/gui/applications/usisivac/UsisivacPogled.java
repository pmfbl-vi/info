 ...
 */
public class UsisivacPogled extends EmptyEnvironmentView {
	...
	protected UsisivacOkruzenje getVacuumEnv() {
		return (UsisivacOkruzenje) env;
	}
	...
	protected List<String> getLocations() {
		...
		if (env != null) {
			result.add(UsisivacOkruzenje.LOKACIJA_A1);
		   result.add(UsisivacOkruzenje.LOKACIJA_A2);
       result.add(UsisivacOkruzenje.LOKACIJA_B1);
       result.add(UsisivacOkruzenje.LOKACIJA_B2);
			}
		return result;
	}
	...
	protected boolean isDirty(String location) {
		return UsisivacOkruzenje.LocationState.Dirty == getVacuumEnv()
	...
	protected Agent getAgent(Object location) {
	  UsisivacOkruzenje e = getVacuumEnv();
