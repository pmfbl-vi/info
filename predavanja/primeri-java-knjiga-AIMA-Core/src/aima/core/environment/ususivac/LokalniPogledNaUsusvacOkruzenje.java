 ...
 * @author Andrew Brown
 */
public class LokalniPogledNaUsusvacOkruzenje extends DynamicPercept {
	 ...
	 */
	public LokalniPogledNaUsusvacOkruzenje(String agentLocation,
			UsisivacOkruzenje.LocationState state) {
	 ...
	 *         <em>Clean</em> or <em>Dirty</em>.
	 */
	public UsisivacOkruzenje.LocationState getLocationState() {
		return (UsisivacOkruzenje.LocationState) getAttribute(ATTRIBUTE_STATE);
	}
	 ...
	 */
	public boolean matches(UsisivacOkruzenjeStanje state, Agent agent) {
