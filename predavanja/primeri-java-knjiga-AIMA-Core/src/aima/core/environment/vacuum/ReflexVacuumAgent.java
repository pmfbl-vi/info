...
public class ReflexVacuumAgent extends AbstractAgent
{
  ...
  public ReflexVacuumAgent()
  {
    super( new AgentProgram()
    {
      ...
      {
        LocalVacuumEnvironmentPercept vep = 
            ( LocalVacuumEnvironmentPercept ) percept;
        ...
        else if ( VacuumEnvironment.LOCATION_A == vep.getAgentLocation() )
        {
          return VacuumEnvironment.ACTION_MOVE_RIGHT;
        }
        else if ( VacuumEnvironment.LOCATION_B == vep.getAgentLocation() )
        {
          // else if location = B then return Left
