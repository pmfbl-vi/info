...
public class LocalVacuum2x2EnvironmentPercept extends DynamicPercept {
	 ...
	 */
	public LocalVacuum2x2EnvironmentPercept(String agentLocation,
			Vacuum2x2Environment.LocationState state) {
	 ...
	 *         <em>Clean</em> or <em>Dirty</em>.
	 */
	public Vacuum2x2Environment.LocationState getLocationState() {
		return (Vacuum2x2Environment.LocationState) getAttribute(ATTRIBUTE_STATE);
	}
	 ...
	 */
	public boolean matches(Vacuum2x2EnvironmentState state, Agent agent) {
